...
with col11:
    ...
    echo_decay = st.slider("Echo Decay", 0.1, 1.0, 0.5, key="echo_decay", help="Set the echo attenuation level.")
with col12:
...
# Generate the complete melody with transformations applied to each note separately
